        ...
        <div class="w-1/3 pl-8">
            ...
            <form class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="descripcion" placeholder="Descripción" class="p-2 border rounded w-full">
                </div>

                <div>
                    <label class="block font-semibold">Precio</label>
                    <input type="number" name="precio" placeholder="Precio" class="p-2 border rounded w-full">
                </div>

                <div>
                    <label class="block font-semibold">Stock</label>
                    <input type="number" name="stock" placeholder="Stock" class="p-2 border rounded w-full">
                </div>
